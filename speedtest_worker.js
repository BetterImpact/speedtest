...
var clientIp = '' // client's IP address as reported by getIP.aspx
...
var settings = {
  ...
  url_dl: 'garbage.aspx', // path to a large file or garbage.aspx, used for download test. must be relative to this js file
  ...
  url_getIp: 'getIP.aspx', // path to getIP.aspx relative to this js file, or a similar thing that outputs the client's ip
  ...
  garbage_chunkSize: 20, // size of chunks sent by garbage.aspx (can be different if enable_quirks is active)
  ...
  url_telemetry: 'telemetry/telemetry.aspx', // path to the script that adds telemetry data to the database
